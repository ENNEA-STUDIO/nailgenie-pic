  ...
  const content = {
    fr: {
      ...
      steps: [
        {
          name: "camera",
          icon: <Camera className="h-10 w-10 text-fuchsia-500" />,
          title: "Prenez une photo",
        },
        {
          name: "customize",
          icon: <Sparkles className="h-10 w-10 text-fuchsia-500" />,
          title: "Personnalisez",
        },
        {
          name: "prompt",
      ...
      >
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-10">
            <h3 className="text-2xl md:text-3xl font-bold mb-6 text-fuchsia-800">
