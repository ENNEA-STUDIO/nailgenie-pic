...
const PhoneDemo: React.FC = () => {
  ...
  const content = {
    fr: {
      title: "Comment fonctionne NailGenie ?",
      steps: [
      ...
      stepDescriptions: [
        "Capturez une photo de vos mains pour une expérience personnalisée",
        "Choisissez votre forme d'ongles, longueur et couleur préférées",
        "Décrivez le style que vous imaginez avec vos propres mots",
        "Notre IA crée instantanément votre design sur mesure"
      ],
      phoneUI: {
        step1: "Étape 1",
        step1Text: "Prenez une photo de vos mains",
        step2: "Étape 2",
        step2Text: "Personnalisez la forme et la longueur",
        step3: "Étape 3",
        step3Text: "Décrivez votre manucure idéale",
        step4: "Étape 4",
        step4Text: "Votre design est généré par IA",
        promptPlaceholder: "\"Ongles roses avec paillettes argentées...\"",
        welcome: "Bienvenue sur",
        appName: "NailGenie"
      }
    },
    en: {
      title: "How does NailGenie work?",
      steps: [
        { name: "camera", icon: <Camera className="h-10 w-10 text-fuchsia-500" />, title: "Take a photo" },
        { name: "customize", icon: <Sparkles className="h-10 w-10 text-fuchsia-500" />, title: "Customize" },
        { name: "prompt", icon: <MessageSquare className="h-10 w-10 text-fuchsia-500" />, title: "Describe" },
        { name: "generate", icon: <Wand2 className="h-10 w-10 text-fuchsia-500" />, title: "Visualize" }
      ],
      stepDescriptions: [
        "Capture a photo of your hands for a personalized experience",
        "Choose your preferred nail shape, length, and color",
        "Describe the style you imagine in your own words",
        "Our AI instantly creates your custom design"
      ],
      phoneUI: {
        step1: "Step 1",
        step1Text: "Take a photo of your hands",
        step2: "Step 2",
        step2Text: "Customize the shape and length",
        step3: "Step 3",
        step3Text: "Describe your ideal manicure",
        step4: "Step 4", 
        step4Text: "Your design is generated by AI",
        promptPlaceholder: "\"Pink nails with silver glitter...\"",
        welcome: "Welcome to",
        appName: "NailGenie"
      }
    }
      ...
      >
        <div className="flex flex-col md:flex-row items-center">
                        ...
                        >
                          {currentStep === 0 && (
                            <div className="text-center flex flex-col items-center">
                              ...
                              <span className="text-xs font-medium text-fuchsia-700 py-1 px-3 bg-white/80 rounded-full mb-2">
                                {content[language].phoneUI.step1}
                              </span>
                              <p className="text-sm text-fuchsia-800 font-medium">
                                {content[language].phoneUI.step1Text}
                              </p>
                          ...
                          {currentStep === 1 && (
                            <div className="text-center flex flex-col items-center">
                              ...
                              <span className="text-xs font-medium text-indigo-700 py-1 px-3 bg-white/80 rounded-full mb-2">
                                {content[language].phoneUI.step2}
                              </span>
                              <p className="text-sm text-indigo-800 font-medium">
                                {content[language].phoneUI.step2Text}
                              </p>
                          ...
                          {currentStep === 2 && (
                            <div className="text-center flex flex-col items-center">
                              ...
                              <span className="text-xs font-medium text-pink-700 py-1 px-3 bg-white/80 rounded-full mb-2">
                                {content[language].phoneUI.step3}
                              </span>
                              <p className="text-sm text-pink-800 font-medium">
                                {content[language].phoneUI.step3Text}
                              </p>
                              ...
                              >
                                <span className="text-xs text-pink-800">
                                  {content[language].phoneUI.promptPlaceholder}
                                </span>
                                <motion.div
                          ...
                          {currentStep === 3 && (
                            <div className="text-center flex flex-col items-center">
                              ...
                              <span className="text-xs font-medium text-fuchsia-700 py-1 px-3 bg-white/80 rounded-full mb-2">
                                {content[language].phoneUI.step4}
                              </span>
                              <p className="text-sm text-fuchsia-800 font-medium">
                                {content[language].phoneUI.step4Text}
                              </p>
                        ...
                        {showInitialLoader && (
                          ...
                          >
                            ...
                            <div className="mt-4 text-center">
                              <p className="text-xs font-medium text-fuchsia-700">{content[language].phoneUI.welcome}</p>
                              <p className="text-sm font-bold text-fuchsia-800">{content[language].phoneUI.appName}</p>
                            </div>
                          </motion.div>
                        )}
                      </AnimatePresence>
          ...
          <div className="md:w-1/2 md:pl-10">
            <h3 className="text-2xl md:text-3xl font-bold mb-6 text-fuchsia-800">{content[language].title}</h3>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {content[language].stepDescriptions[index]}
                    </p>
                  </div>
                </motion.div>
              ))}
