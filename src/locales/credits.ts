...
export const creditsTranslations: Record<Language, CreditsTranslations> = {
  en: {
    ...
    selectOption: 'Select an option below to continue creating stunning nail designs',
  ...
  fr: {
    ...
    lowCredits: "Crédits faibles ! Achetez-en plus",
    ...
    selectOption: 'Sélectionnez une option ci-dessous pour continuer à créer de superbes designs d\'ongles',
